...
For detailed access instructions, API references, and download guidance see [docs/data_sources.md](docs/data_sources.md).

For bounding boxes, fire-prone regions, and Alaska-specific geospatial notes see [docs/alaska_region_guide.md](docs/alaska_region_guide.md).
